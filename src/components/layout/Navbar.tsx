...
export function Navbar() {
  ...
  return (
    <>
                ...
                if (action) {
                  return (
                    <button
                      ...
                      onClick={action}
                      className={cn(
                        "flex flex-col md:hidden items-center gap-1 px-3 py-2 rounded-lg transition-all duration-200",
      ...
      {mobileSearchOpen && (
        <div className="fixed inset-0 z-[60] bg-background md:hidden animate-fade-in">
          <div className="flex items-center gap-3 p-4 border-b border-border">
            ...
            <div className="flex-1">
              <UserSearch onSelect={() => setMobileSearchOpen(false)} />
            </div>
          </div>
